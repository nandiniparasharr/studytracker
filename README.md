...
- **Dashboard** - greeting, this week's totals (today, week, session count,
  ...
  that darkens in two-hour bands: under 2h, 2-4h, 4-6h, over 6h), your
  subject split as a donut, recent sessions, and weekly-goal progress. Use the date range control in the top right to
